...
/**
 * Hero section introducing the portfolio owner. Includes a round avatar,
 * animated headings and social icons. The accent colour comes from
 * siteConfig.accentColor. Animations are powered by Framer Motion.
 */
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative isolate overflow-hidden bg-white pt-24 md:pt-32"
    ...
    >
      ...
      />
      <div className="mx-auto flex max-w-7xl flex-col items-center px-8 py-12 md:flex-row md:items-center md:justify-between md:px-24 lg:px-32">
        {/* Left content */}
        <div className="space-y-6 text-center md:text-left">
          ...
          >
            I'm{' '}
            <span style={{ color: siteConfig.accentColor }}>{siteConfig.name}</span>
          </motion.h1>
          <motion.p
            variants={fadeUp}
            initial="hidden"
            animate="visible"
            className="max-w-xl text-base font-medium text-gray-600 sm:text-lg md:text-xl"
            style={{ '--delay': '0.4s' }}
          >
            {siteConfig.title}
          </motion.p>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="mt-4 flex justify-center gap-4 md:justify-start"
          >
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="mt-8 md:mt-0 md:ml-12"
        >
          {/* Replace `/profile.jpg` with your own image in the public folder */}
